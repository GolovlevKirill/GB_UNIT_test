...
//        ).isInstanceOf(IllegalStateException.class);
    ...
    @Test
    @DisplayName("Тест подсчета скидки")
    public void testCalcDiscount() {
        System.out.println("Выполнение теста подсчета скидки");
        assertEquals(870, calculator.calculatingDiscount(1000, 13));
        assertEquals(1800, calculator.calculatingDiscount(2000, 10));

    }

    @Test
    @DisplayName("Проверка метода calculatingDiscount при использовании недопустимых аргументов на генерацию исключений")
    public void testAssertThrows() {
        System.out.println("Выполнение теста недопустимых параметров");
        assertThrows(ArithmeticException.class, () -> calculator.calculatingDiscount(-1000, 0));
    }
}